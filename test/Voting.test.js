...
//     let [acc1, acc2, acc3] = ethers.getSigners()
//     const VotingContract = await ethers.getContractFactory("VotingContract");
//     votingContract = await VotingContract.deploy(["Candidate 1", "Candidate 2", "Candidate 3"]);
...
// //     let candidate1 = await votingContract.candidates(1);
